...
import 'package:gmaps/pages/data_dummy.dart';
import 'package:gmaps/pages/map_type_google.dart';
      ...
      child: SizedBox(
        ...
        child: ListView(
          ...
          children: [
            ...
            _displayPlaceCard(
                "https://galaxymall.co.id/wpcontent/uploads/2022/11/one_galaxy_tampak_01-600x600.jpg",
                "Galaxy Mall 3",
                -7.2756967,
                112.7806254),
            const SizedBox(
